...
const FAQ = () => (
  ...
  <h1 className="Slow">Frequently Ask Question</h1>
   ...
   <body className="hogo">A virtual assistant can do scheduling, manage travels, copy-writing, create website, projects, SEO and real estate. </body>
   <header >What can you garantee to your clients?</header>
   <body className="sogo">I can garantee to my clients or to my future clients that in everything that they'll request is done with complete care so they could make the most out of their life.</body>
   </div> 
