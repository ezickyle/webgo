...
const FAQ = () => (
  ...
  <div>
   ...
   <body className="sogo">I can garantee to my clients or to my future clients that everything that they'll request is done with complete care and worry free.</body>
   </div> 
  </div>
